...
class Winning11DataItem(scrapy.Item):
    ...
    win_rate_max = scrapy.Field()
    win_rate_min = scrapy.Field()
    draw_rate_max = scrapy.Field()
    draw_rate_min = scrapy.Field()
    lost_rate_max = scrapy.Field()
    lost_rate_min = scrapy.Field()
